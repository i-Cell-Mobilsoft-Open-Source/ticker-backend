...
| quarkus.otel.enabled | OpenTelemetry - enabled config: https://quarkus.io/version/3.20/guides/all-config#quarkus-opentelemetry_quarkus-otel-enabled[Link] | QUARKUS_OTEL_ENABLED | true
| quarkus.otel.service.name | OpenTelemetry service name | QUARKUS_OTEL_SERVICE_NAME | `${quarkus.application.name}` (artifact id)
| quarkus.otel.traces.exporter | OpenTelemetry trace exporter. Note: `jaeger` exporter is no longer supported: https://quarkus.io/version/3.20/guides/all-config#quarkus-opentelemetry_quarkus-otel-traces-exporter[Link] | QUARKUS_OTEL_TRACES_EXPORTER | otlp
| quarkus.otel.traces.sampler | OpenTelemetry trace sampler type: https://quarkus.io/version/3.20/guides/all-config#quarkus-opentelemetry_quarkus-otel-traces-sampler[Link] | QUARKUS_OTEL_TRACES_SAMPLER | `parentbased_always_on`. Allowed values: `always_on`, `always_off`, `traceidratio`, `parentbased_always_on`, `parentbased_always_off`, `parentbased_traceidratio`
| quarkus.otel.traces.sampler.arg | OpenTelemetry trace sampler ratio - only relevant when sampler is `traceidratio` or `parentbased_traceidratio`: https://quarkus.io/version/3.20/guides/all-config#quarkus-opentelemetry_quarkus-otel-traces-sampler-arg[Link] | QUARKUS_OTEL_TRACES_SAMPLER_ARG | 1.0d
| quarkus.otel.exporter.otlp.endpoint | OpenTelemetry Collector gRPC endpoint for traces: https://quarkus.io/version/3.20/guides/all-config#quarkus-opentelemetry_quarkus-otel-exporter-otlp-endpoint[Link] | QUARKUS_OTEL_EXPORTER_OTLP_ENDPOINT | http://localhost:4317
| quarkus.otel.metrics.enabled | OpenTelemetry metrics - enabled config. Must be true for Micrometer OTLP delegation, setting to false disables all metrics: https://quarkus.io/version/3.20/guides/all-config#quarkus-opentelemetry_quarkus-otel-metrics-enabled[Link] | QUARKUS_OTEL_METRICS_ENABLED | true
| quarkus.micrometer.export.otlp.enabled | Enable Micrometer OTLP-based metric export | QUARKUS_MICROMETER_EXPORT_OTLP_ENABLED | true
| quarkus.micrometer.export.otlp.url | OpenTelemetry Collector endpoint for metrics | QUARKUS_MICROMETER_EXPORT_OTLP_URL | http://localhost:4318/v1/metrics
| quarkus.micrometer.export.otlp.resource-attributes | Micrometer resource attributes | QUARKUS_MICROMETER_EXPORT_OTLP_RESOURCE_ATTRIBUTES | `service.name=${quarkus.application.name}`
