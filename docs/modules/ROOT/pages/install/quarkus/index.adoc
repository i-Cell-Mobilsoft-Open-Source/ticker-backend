...
| quarkus.otel.traces.exporter | OpenTelemetry trace exporter. Note: `jaeger` exporter is no longer supported: https://quarkus.io/version/3.15/guides/all-config#quarkus-opentelemetry_quarkus-otel-traces-exporter[Link] | QUARKUS_OTEL_TRACES_EXPORTER | otlp
| quarkus.otel.traces.sampler | OpenTelemetry trace sampler type: https://quarkus.io/version/3.15/guides/all-config#quarkus-opentelemetry_quarkus-otel-traces-sampler[Link] | QUARKUS_OTEL_TRACES_SAMPLER | `parentbased_always_on`. Allowed values: `always_on`, `always_off`, `traceidratio`, `parentbased_always_on`, `parentbased_always_off`, `parentbased_traceidratio`
| quarkus.otel.traces.sampler.arg | OpenTelemetry trace sampler ratio - only relevant when sampler is `traceidratio` or `parentbased_traceidratio`: https://quarkus.io/version/3.15/guides/all-config#quarkus-opentelemetry_quarkus-otel-traces-sampler-arg[Link] | QUARKUS_OTEL_TRACES_SAMPLER_ARG | 1.0d
| quarkus.otel.exporter.otlp.endpoint | OpenTelemetry Collector gRPC endpoint for traces: https://quarkus.io/version/3.15/guides/all-config#quarkus-opentelemetry_quarkus-otel-exporter-otlp-endpoint[Link] | QUARKUS_OTEL_EXPORTER_OTLP_ENDPOINT | http://localhost:4317
